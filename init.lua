...
do -- app manager
    ...
    mode:bind({}, "i", app_man:toggle("Ghostty"))
    mode:bind({"shift"}, "i", app_man:toggle("iTerm"))
...
-- @see https://github.com/Hammerspoon/hammerspoon/issues/991#issuecomment-529682755
